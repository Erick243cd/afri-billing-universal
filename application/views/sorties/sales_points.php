								...
								<tr>
									...
									<td class="text-right">
										<a class="btn-outline-primary btn-sm"
										   href="<?= base_url() ?>sorties/printBySalesPoint/<?= $row->salespoint_id ?>">Rapport
											de réapprovisionnement</a>
										<a class="btn-outline-success btn-sm"
										   href="<?= base_url() ?>sorties/stockBySalesPoint/<?= $row->salespoint_id ?>">Rapport
											de stock</a>
									</td>
								</tr>
							<?php endforeach; ?>
