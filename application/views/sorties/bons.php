...
<head>
	<meta charset="utf-8"/>
	<link href="<?php echo base_url() ?>assets/img/favicon.png" rel="icon" type="image/png"><link href="<?php echo base_url() ?>assets/img/favicon.png" rel="icon" type="image/png">
	<!--	Core MDB-->
...
<div class="card p-5 m-5">
	...
	<div class="d-flex justify-content-between">
		...
		<div class="col-sm-3">
			<p>
				<span class="font-weight-bold">Rapport  n° : #<?= $sales_point->salespoint_id ?></span><br/>
